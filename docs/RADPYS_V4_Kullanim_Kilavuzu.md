...
### 🐾 13.3 Rapor Şablonu, Logo ve Kurumsal Marka Ayarları
...
RADPYS V4 veritabanı altyapısı; KVKK ve kişisel sağlık verilerini koruma kanunlarına tam uyumlu olarak **SQLCipher 256-bit AES askeri düzeyde şifreleme** ile korunmaktadır. Yetkisiz kişilerin veya üçüncü taraf yazılımların veritabanı dosyasını doğrudan açması engellenmiştir.
