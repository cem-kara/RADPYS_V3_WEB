...
| 3 | README.md Mevzuat Düzeltmeleri | 3153 S.K., Sağlık Kuralları Yönetmeliği Md.9 | 🔴 Yüksek | Çok Düşük |
| 4 | Cihaz Kalite Kontrol / Kalibrasyon Takibi | NDK RGY, SKS 6.1 | 🟡 Orta-Yüksek | Yüksek |
| 5 | Kurum/İşyeri NDK Lisansı Takibi | Radyasyon Tesislerine İlişkin Yetkilendirmeler Yön. | 🟡 Orta | Orta |
| 6 | RGS/RSO Görevlendirme & Sertifika Takibi | NDK RGY | 🟡 Orta | Düşük-Orta |
| 7 | Gebelik Bildirim/Rapor İş Akışı | Sağlık Kuralları Yönetmeliği | 🟢 Orta-Düşük | Düşük-Orta |
...
## 3. README.md Mevzuat Düzeltmeleri

Doğrulanan üç hata, kaynaklarıyla birlikte:

| README'deki hatalı ifade | Doğru değer | Yasal dayanak |
|---|---|---|
| "yıllık 4 haftalık (28 gün) şua izni" | **30 gün** (kıstelyevm esaslı 0-30 gün) | 3153 sayılı Kanun ve Sağlık Bakanlığı Radyasyon Görevlilerinin Sağlık İzinlerine İlişkin Yönetmelik |
| "6 aylık zorunlu... muayene" (genel muayene bağlamında) | **Yılda 1 kez / 365 gün** (6 ay sadece şua izni kontrol muayenesine özel) | İyonlaştırıcı Radyasyon Kaynakları ile Çalışan Personelin Sağlık Kuralları Hakkında Yönetmelik Md. 9 |
| "5 mSv yıllık inceleme eşiği" | **5 mSv = tek periyot (1-2 aylık okuma) anomali eşiği**; yıllık limit ayrı olarak 20 mSv | NDK mevzuatı |

Kod ve Kullanım Kılavuzu zaten doğru; sadece `README.md` metni bu üç noktada güncellenmeli. Bu, kullanıcıya/denetçiye yanlış izlenim verebileceği için düşük efor–yüksek risk azaltma oranına sahip, hemen yapılabilecek bir düzeltme.

**Tahmini efor:** Çok düşük (metin düzeltmesi, ~15 dakika).

---

## 4. Cihaz Kalite Kontrol / Kalibrasyon Takibi
...
## 5. Kurum/İşyeri NDK Lisansı ve Cihaz Lisans Süre Takibi
...
CREATE TABLE kurumsal_lisanslar (
    ...
    lisans_no       TEXT,
    ilgili_cihaz_id INTEGER REFERENCES cihazlar(id),  -- madde 4 uygulanırsa bağlanabilir, yoksa NULL
    verilis_tarihi  DATE,
...
**Tahmini efor:** Orta — bağımsız çalışabilir (madde 4'e bağımlı değil), önce bu yapılabilir.

---

## 6. RGS/RSO Görevlendirme ve Sertifika Takibi
...
## 7. Gebelik Bildirim/Rapor İş Akışı
...
```
Faz 0 (bugün, ~1 saat):  Madde 3 — README.md düzeltmeleri
...
Faz 3 (3-5 gün):         Madde 6 — RGS/RSO Görevlendirme Takibi
Faz 4 (3-5 gün):         Madde 5 — Kurumsal Lisans Takibi
Faz 5 (1-2 gün araştırma + geliştirme): Madde 7 — Gebelik Bildirim İş Akışı (önce kod kontrolü)
Faz 6 (2-3 hafta, ayrı sprint): Madde 4 — Cihaz Kalite Kontrol/Kalibrasyon Modülü (en büyük kapsam)
```
